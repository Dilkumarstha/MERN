...
const PageNotFound = () => {
  return (
    ...
    <a className='p-3 m-10 bg-red-700 hover:bg-red-900' href={HOME_ROUTE}>Return to Home Page</a>
    <a className='p-3 m-10 bg-red-700 hover:bg-red-900' href='/'>Return to Default Page</a>
